...
export default class Lot50Screen extends React.Component{
    state={
        screenHeight: 0,
    }
                ...
                <ScrollView onContentSizeChange={this.onContentSizeChange}>
                    <View style={styles.container}>
                        ...
                        <Text style={styles.cardInfo}>
                            ...
                            {"\n"}
                            Average Time to Campus:<Text style={styles.importantText}> 16 Minutes</Text>    
                            {"\n"}
                            Total Number of Spots:<Text style={styles.importantText}> 326</Text>
                            {"\n"}
                            Best Time to Park: <Text style={styles.importantText}> Before 12PM, After: 4PM</Text>
                            {"\n"}
                            
                        </Text>               
                    </View>
                    <View style={{height: 600}}>
                        <Image source = {require("../../assets/parkingPictures/Lot50.png")} style={{width: 420, height: 400}}></Image>
                    </View> 
                </ScrollView>
            </SafeAreaView>
        );
