...
export default class Lot24Screen extends React.Component{
    state={
        screenHeight: 0,
    }
                ...
                <ScrollView onContentSizeChange={this.onContentSizeChange}>
                    <View style={styles.container}>
                        ...
                        <Text style={styles.cardInfo}>
                            ...
                            {"\n"}
                            Average Time to Campus:<Text style={styles.importantText}> 16-17 Minutes</Text>    
                            {"\n"}
                            Total Number of Spots:<Text style={styles.importantText}> 387</Text>
                            {"\n"}
                            Best Time to Park: <Text style={styles.importantText}> Red, Blue: Before 6PM</Text>
                            {"\n"}
                            For Gold Permits: <Text style={{fontWeight: "bold"}}>After 6PM</Text>
                        </Text>               
                    </View>
                    <View style={{height: 600}}>
                        <Image source = {require("../../assets/parkingPictures/Lot24.png")} style={{width: 420, height: 400,}}></Image>
                    </View> 
                </ScrollView>
            </SafeAreaView>
        );
